...
## Ejemplos de tipos de esta vulnerabilidad
...
✅ Aplicable - Los usuarios pueden manipular prompts para evadir filtros de seguridad mediante ataques adversariales.
